   ...
   public function add_cart(Request $request,$id){
    ...
    if(Auth::id()){
...

        {
            ...
            $cart = catr::find($product_exist_id)->first();

            $quantity = $cart->quantity;

            $cart->quantity = $quantity + $request->qunatity;
...

        {
            ...
            if($product->discount_price!=null)
            {
                ...
                $cart->price=$product->discount_price * $request->qunatity;
            }
            else
            {
                $cart->price=$product->price * $request->qunatity;
            }
